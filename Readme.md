...
Desarrollé este proyecto web para facilitar la gestión de animales rurales y el cálculo de producción diaria, ingresos y ganancia neta. Rediseñé la interfaz con un enfoque profesional, incorporando un fondo visual realista compuesto por animales de granja en su entorno natural. Además, implementé una calculadora inteligente que se adapta automáticamente al tipo de animal seleccionado, mostrando unidades de producción específicas como litros, huevos o kilos según corresponda.
